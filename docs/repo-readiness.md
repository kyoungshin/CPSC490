...
| Count | Status |
|---:|---|
| **4** *(was 3)* | ✅ **Ready** — scaffold, bootstrap, CI green |
| **5** | ⚠️ **Partial** — repo exists, setup incomplete |
| **4** *(was 5)* | ❌ **Empty or never shared** — nothing gradeable |
| **7** | ⬜ **No repository** found anywhere |
...
| 08 | Crime Busters | — | ⬜ no repo | No repository found. | Create it, copy the scaffold, add `kyoungshin`, run bootstrap. |
...
| 12 | ACJMM | `CharlesSinde/CPSC490-G12-ACJMM` | ❌ empty | **Zero commits.** Created 3 Sep, instructor added, nothing ever pushed. Unchanged. | Copy the scaffold and push, then run bootstrap. |
...
### No repository yet — groups 03 · 04 · 07 · 08 · 13 · 15 · 18
...
### Scaffold missing or incomplete — groups 09 · 10 · 11 · 12 · 14 · 20
