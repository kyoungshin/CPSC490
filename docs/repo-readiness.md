...
**CPSC 490 · Fall 2026 · swept 24 Sep 2026, 03:30 UTC** (first sweep 18 Sep, 20:00 UTC). *Evening edition (on demand).*
...
### Since the last sweep (23 Sep, 15:36 UTC)

**One group moved: Group 15 (HIBBI-01) shared its repository with the instructor** — `kyoungshin` now has write access to `Isaiah714/CPSC490-G15-HIBBI-01`, which was already scaffolded and bootstrapped, so it goes *partial* → **ready**. Everything else is unchanged; Group 01 pushed new commits but its status did not change. Team-filed issues still **5** across four groups (G04 ×2, G07, G11, G12).
...
| Count | Status |
|---:|---|
| **16** *(was 15)* | ✅ **Ready** — scaffold, bootstrap, CI green |
| **3** *(was 4)* | ⚠️ **Partial** — repo exists, setup incomplete or unshared |
...
| 07 | Mighty Morphines | `CPSC490-Team-Proj/CPSC490-G07-MightyMorphin` | ✅ ready | **Renamed to `G07`** (leading zero fixed) and filed the team's first issue (#1, project objectives) on 22 Sep. Bootstrap complete. | File epics and stories. |
...
| 15 | HIBBI-01 | `Isaiah714/CPSC490-G15-HIBBI-01` | ✅ ready · 🆕 moved | **Shared with the instructor** (write access) on 23 Sep — the one step it was missing. Scaffolded and bootstrapped (4 milestones, `develop`, `.github/` present). No team-filed issues yet. | File epics and stories. |
