...
| [`scripts/bootstrap.sh`](scripts/bootstrap.sh) | one command creates 17 labels, 4 sprint milestones, `develop`, branch protection, and a project board with Status / Story Points / Sprint fields |
